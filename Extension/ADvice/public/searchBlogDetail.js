...
var listData = {
  badList: [
    {
      data: "오늘은 동네 스타벅스에서, 2주마다 책 한 권을 읽고 만나는 독서 모임이 있는 날이다. ",
      id: "SE-80b0e665-ef6b-11ee-b3a5-09cbc8bc88db",
    },
    {
      data: "모이면 수다 반, 책 이야기 반으로 편안하게 이야기한다. 벌써 4년 차다. ㅎㅎㅎ ",
      id: "SE-80b0e666-ef6b-11ee-b3a5-f113d835b88a",
    },
    {
      data: "그동안 멤버 교체 없이, 참여율 100%를 유지하며 즐겁게 만나고 있다.",
      id: "SE-80b0e667-ef6b-11ee-b3a5-058454c0be21",
    },
  ],
  goodList: [
    {
      data: "수다도 즐겁지만 책 이야기를 하는 것도 즐겁다. 책에 관한 이야기를 하면서 공감 가는 부분…람들 생각하는 것은 비슷비슷하구나라는 생각도 들고 작지만 많은 것을 느끼고 배우게 된다.",
      id: "SE-80b10d82-ef6b-11ee-b3a5-03f88dca99fd",
    },
    { data: "​", id: "SE-80b10d83-ef6b-11ee-b3a5-590cc5050f6a" },
    {
      data: "일요일 오전의 이런 힐링 시간이 고맙고 즐겁다. 또 이런 시간을 유지하기 위해 서로 노력하고 배려해 주는 우리 멤버분들께도 감사하다.",
...
listData.goodList.forEach(function (item) {
  ...
  if (element) {
    element.style.backgroundColor = "rgba(66, 189, 101, 0.3)";
  }
});
