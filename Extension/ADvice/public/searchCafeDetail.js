...
function setting() {
  ...
  optionTwo(document.getElementById("cafe_main").contentWindow.document);
  optionThree(document.getElementById("cafe_main").contentWindow.document);
  ...
  if (optionCnt === 2) {
    var checkInterval = setInterval(function () {
      ...
      if (iframeElements.length > 0) {
        ...
        const title = iframeDoc.querySelector(".title_text");
