...
from services.text_emotion_quant_prediction import TextEmotionQuantPrediction
from models.exception.custom_exception import CustomException


class EmotionQuantPredictionService:
    # 초기화
    def __init__(self):
        self.__text_emotion_prediction = TextEmotionQuantPrediction()
