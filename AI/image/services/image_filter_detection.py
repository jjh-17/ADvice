...
class ImageAnalyzer:
    def __init__(self):
        ...
        self.edge_strength_mean = 600
        self.laplacian_var_mean = 400
    ...
    def calculate_filter_value(self, url):
        image = self.downloader.load_image_from_url(url)
    ...
    def _get_laplacian_var(self, gray_image):
